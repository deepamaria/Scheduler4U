...
<div className='MainPage h-full w-full'>
  <div className='topSide h-2/3 w-full sm:h-full w-2/3 md:h-full w-2/3 lg:h-full w-2/3'>
  ...
  <div id="slide6" className="carousel-item relative w-full">
    ...
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
      ...
      <a href="#slide1" className="btn btn-circle btn-cyan-600 bg-gradient-to-r from-cyan-500 shadow-2xl shadow-cyan-500/50">❯</a>
            ...
            <div className='bottomSide h-1/3 w-full sm:h-full w-1/3 md:h-full w-1/3 lg:h-full w-1/3 flex flex-col items-center'>
